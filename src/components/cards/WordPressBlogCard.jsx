  ...
  return (
    <div>
      <MotionDivDownToUp>
        <div
          id="cardBlog"
          className="w-[290px] phone2:w-[300px] phone3:w-[350px] tablet1:w-[400px] font-mainFont flex flex-col desktop1:max-w-[500px] desktop3:max-w-[375px] bg-quartenary rounded-2xl p-[20px]"
        >
          ...
          <h1
            className="mt-4 text-title1 leading-[25px] font-bold font-secondFont mb-[12px] text-white"
            title="blogTitle"
          >
            {title}
          </h1>
          <h2
            className="text-paragraph3 font-light font-secondFont mb-[32px] text-white/60 leading-[18px] desktop1:leading-[21px]  "
            title="blogSubtitle"
          >
            {subtitle}
          </h2>
