                      ...
                      return (
                        <li key={id}>
                          <a
                            ...
                            title={item}
                            data-track={id}
                            className="cursor-pointer bg-gradient-to-r from-white to-white bg-[length:0%_2px] bg-no-repeat bg-left-bottom transition-[background-size] duration-300 hover:bg-[length:100%_2px]"
                            onClick={(e) => {
                              e.preventDefault()
